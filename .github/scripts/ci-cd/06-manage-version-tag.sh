...
# Description: Automated Git tagging engine. Computes semantic increments based on
# commit history headers and publishes the next version.
# ==============================================================================
...
# Registers the variable in the pipeline step's native output for subsequent external
# use.
