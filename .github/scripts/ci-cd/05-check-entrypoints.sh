...
# if the architecture compiles as a binary package application or operates strictly
# as a reusable downstream library core.
# ==============================================================================
...
if [ -f "$ENTRY_FILE" ]; then
  ...
  # Strip comment references and blank space line elements to isolate structural
  # data
